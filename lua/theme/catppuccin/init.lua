...
local editor = lush(function(injected_functions)
    ...
    return {
        ...
        FloatBorder                           { NormalFloat, fg = NormalFloat.bg                             }, -- Border of floating windows.
        ...
        TelescopePreviewBorder                { TelescopeBorder, bg = crust                                  },
        TelescopePromptTitle                  { TelescopeTitle, bg = base                                    },
        TelescopePromptNormal                 { TelescopeNormal, bg = base                                   },
        TelescopePromptBorder                 { TelescopeBorder, bg = base                                   },
        ...
        TelescopeResultsBorder                { TelescopeBorder, bg = mantle                                 },
        ...
        NotifyERRORBorder                     { NotifyERRORBody, fg = NotifyERRORBody.bg                     },
        ...
        NotifyWARNBorder                      { NotifyWARNBody, fg = NotifyWARNBody.bg                       },
        ...
        NotifyINFOBorder                      { NotifyINFOBody, fg = NotifyINFOBody.bg                       },
        ...
        NotifyDEBUGBorder                     { NotifyDEBUGBody, fg = NotifyDEBUGBody.bg                     },
        ...
        NotifyTRACEBorder                     { NotifyTRACEBody, fg = NotifyTRACEBody.bg                     },
        ...
        NoiceCmdlinePopupBorder               { NoiceCmdlinePopup, fg = NoiceCmdlinePopup.bg                 },
