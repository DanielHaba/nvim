...
-- vim.opt.background     =                                   -- "dark" or "light", used for highlight colors
...
-- vim.opt.cmdheight      =                                   -- number of lines to use for the command-line
...
-- vim.opt.conceallevel   =                                   -- whether concealable text is shown or hidden
...
-- vim.opt.endoffile      =                                   -- write CTRL-Z at end of the file
...
-- vim.opt.eventignorewin =                                   -- autocommand events that are ignored in a window
vim.opt.expandtab         = true                              -- use spaces when <Tab> is inserted
vim.opt.exrc              = true                              -- read init files in the current directory
-- vim.opt.fileencoding   =                                   -- file encoding for multibyte text
...
vim.opt.fillchars         = "eob: "                           -- characters to use for displaying special items
...
-- vim.opt.guifont        =                                   -- GUI: Name(s) of font(s) to be used
...
-- vim.opt.iskeyword      =                                   -- characters included in keywords
...
-- vim.opt.lispoptions    =                                   -- changes how Lisp indenting is done
-- vim.opt.lispwords      =                                   -- words that change how lisp indenting works
-- vim.opt.list           =                                   -- show <Tab> and <EOL>
...
-- vim.opt.mousemoveevent =                                   -- report mouse moves with <MouseMove>
...
-- vim.opt.numberwidth    =                                   -- number of columns used for the line number
...
-- vim.opt.regexpengine   =                                   -- default regexp engine to use
...
-- vim.opt.shiftround     =                                   -- round indent to multiple of shiftwidth
vim.opt.shiftwidth        = 4                                 -- number of spaces to use for (auto)indent step
vim.opt.shortmess         = "ltToOFWcC"                       -- list of flags, reduce length of messages
-- vim.opt.showbreak      =                                   -- string to use at the start of wrapped lines
-- vim.opt.showcmd        =                                   -- show (partial) command somewhere
-- vim.opt.showcmdloc     =                                   -- where to show (partial) command
...
-- vim.opt.showtabline    =                                   -- tells when the tab pages line is displayed
-- vim.opt.sidescroll     =                                   -- minimum number of columns to scroll horizontal
-- vim.opt.sidescrolloff  =                                   -- min. nr. of columns to left and right of cursor
...
-- vim.opt.smoothscroll   =                                   -- scroll by screen lines when 'wrap' is set
...
-- vim.opt.statuscolumn   =                                   -- custom format for the status column
...
-- vim.opt.tabclose       =                                   -- which tab page to focus when closing a tab
...
-- vim.opt.tagfunc        =                                   -- function to get list of tag matches
...
-- vim.opt.timeoutlen     =                                   -- time out time in milliseconds
...
vim.opt.undodir           = os.getenv("HOME") .. "/.vim/undo" -- where to store undo files
...
-- vim.opt.updatetime     =                                   -- after this many milliseconds flush swap file
...
-- vim.opt.whichwrap      =                                   -- allow specified keys to cross line boundaries
...
-- vim.opt.winfixbuf      =                                   -- keep window focused on a single buffer
